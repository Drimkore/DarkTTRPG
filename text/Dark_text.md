...
когда отряд атакует другой отряд, он должен совершить проверку *Стали*. Если бросок провален, то он наносит урон равны показателю *опасности*. Если бросок успешен, то урон увеличивается на значение десятков на броске.
...
Если отряд превосходит численностью отряд противника, он получает бонус +10 к *стали* и +10 к *знамени*.  
...
Если бросок успешен, персонаж игрока не ранен. 
Если бросок провален, игрок выбирает один из двух вариантов:
* вычеркивает количество ранений равное полученному урону, за вычетом брони. 
* Ведущий дает персонажу состояние, подходящее контексту ситуации.
